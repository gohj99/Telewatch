...
import com.gohj99.telewatchlite.ui.CustomButton
import com.gohj99.telewatchlite.ui.main.ErrorScreen
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                val request = Request.Builder()
                    .url("https://api.github.com/repos/gohj99/telewatchlite/releases/latest")
                    .build()

                client.newCall(request).enqueue(object : Callback {
                    override fun onFailure(call: Call, e: IOException) {
                        Log.e(
                            "com.gohj99.telewatchlite.CheckUpdateActivity",
                ...
                Log.e("com.gohj99.telewatchlite.CheckUpdateActivity", "Error: ${e.message}")
